...
**Read Next If:** creating new files → layout.md; writing functions → writing.md; writing tests → quality.md.
...
- 单行内完成，不换行。若参数列表过长（>80 字符），可缩略为类型名省略参数名。
